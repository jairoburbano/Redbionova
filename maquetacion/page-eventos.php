...
<div class="bg-content">
	<div class="wrap">
		...
		<div class="events events--no-sidebar clearfix">
			...
			<div class="events__content">
				<div class="events__item">
					<div class="events__item__date">
						<div class="events__item__date--start">del <span class="events__item__date--day">04</span> <span class="events__item__date--month">agosto</span></div>
						<div class="events__item__date--end">a <span class="events__item__date--day">07</span> <span class="events__item__date--month">agosto</span></div>
					</div>
					<h2 class="events__title"><a href="single-eventos.php">Seminario de difusión científica centro de excelencia en medicina de precisión: Desarrollando ciencia para el mundo</a></h2>
					<div class="events__item__meta">
						<p>Hora: 08:30 hrs</p>
						<p>Lugar: Great room Hotel W Isidora Goyenechea 3000, Las Condes.</p>
					</div><!--/.events__item__meta-->
				</div><!-- /.events__item -->
				<div class="events__item">
					<div class="events__item__date">
						<div class="events__item__date--single"><span class="events__item__date--day">04</span> <span class="events__item__date--month">agosto</span></div>
					</div>
					<h2 class="events__title"><a href="single-eventos.php">Seminario de difusión científica centro de excelencia en medicina de precisión: Desarrollando ciencia para el mundo</a></h2>
					<div class="events__item__meta">
						<p>Hora: 08:30 hrs</p>
